...
from .Reservoir_and_Basin_Analysis_provider import ReservoirAndBasinAnalysisProvider
...
class ReservoirAndBasinAnalysisPlugin(object):
    ...
    def initProcessing(self):
        ...
        self.provider = ReservoirAndBasinAnalysisProvider()
